 ...
 */
export const getProductsWithNewCurrency = (
  products,
  newCurrency,
  ft1,
  ft2,
  ...
  var newProducts = products.map(convertProductCurrency);

  if (ft1.startsWith("1")) {
    newProducts = getFilterPriceWithCurrency(newProducts, ft1);
  } else if (ft2.startsWith("1")) {
    newProducts = getFilterPriceWithCurrency(newProducts, ft2);
  } else if (ft3.startsWith("1")) {
    newProducts = getFilterPriceWithCurrency(newProducts, ft3);
  }
